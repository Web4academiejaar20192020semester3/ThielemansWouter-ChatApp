...
public class PersonService {
    ...
    public PersonService() {
        messageRepositoryStub.addToConversation(personRepository.get("jan@ucll.be"), personRepository.get("an@ucll.be"), "");
        messageRepositoryStub.addToConversation(personRepository.get("an@ucll.be"), personRepository.get("jan@ucll.be"), "");

        messageRepositoryStub.addToConversation(personRepository.get("jan@ucll.be"), personRepository.get("bib@ucll.be"), "");
        messageRepositoryStub.addToConversation(personRepository.get("bib@ucll.be"), personRepository.get("jan@ucll.be"), "");
    }
